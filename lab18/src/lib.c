...
void deleteStructElement(struct Instrument** pInstrument, struct Bow* bow, enum Material* material) {

    FILE * file = fopen("/home/kate/Programming-Belchynska/lab18/instrumentsOut.txt", "r");
    readFromFile(pInstrument);
