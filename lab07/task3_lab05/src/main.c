...
int compare_nums_while(int num1, int num2);//попереднє оголошення функції
int compare_nums_do(int num1, int num2);//попереднє оголошення функції
int main() {
	srand(time(NULL));
	...
	int result_while = compare_nums_while(sum_half1, sum_half2);//функція порівнює дві половини числа
	int result_do = compare_nums_do(sum_half1, sum_half2);//функція порівнює дві половини числа
...
int compare_nums_while(int num1, int num2) {
...
int compare_nums_do(int num1, int num2) {
